...
public sealed class Location
{
    ...
    public static Result<Location, DomainError> Create(Guid lovationId, string name, string city, string street, string house, string apartment)
    {
